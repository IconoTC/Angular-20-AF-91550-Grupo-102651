...
@Component({
  ...
  template: ` 
    <input #searchInput type="text" placeholder="Search..." [(ngModel)]="text" /> 
...
export class Search  {
  ...
  protected readonly inputElement = viewChild<ElementRef>('searchInput')


  constructor() {
    console.log('Input', this.inputElement())

    effect(() => {
      console.log('Input on effect', this.inputElement())
    })
  }

  // ngOnInit(): void {
  //   console.log('Input on init', this.inputElement())
  // }
